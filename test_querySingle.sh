...
### -c: complete execution. 	
	...
	# echo "./test_queryShot.sh $testid_poly ../queries.tv13.$5.shot4 ......"
	./test_querySingle.sh $testid_full ../queries.tv13.$5.full
	# mv CDVS-client.time ../results/$testid_shot4/ 
...
nQueries=`wc -l ../queries.names | cut -d' ' -f1`
...
# matlab -nojvm -nodisplay -nosplash -r "prepare_treceval('$1','../queries.names')"
